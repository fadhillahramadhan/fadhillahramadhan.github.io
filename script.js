...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (document.getElementById("projectSearch")) {
    ...
    const projectSections = document.querySelectorAll("[data-category]");
    ...
    function performSearch() {
      ...
      if (searchTerm === "" && currentFilter === "all") {
        ...
        const filterText =
          currentFilter === "all" ? "" : ` in ${currentFilter} projects`;
        resultsCount.textContent = `Found ${visibleCount} project${
          visibleCount !== 1 ? "s" : ""
        }${filterText}`;
      }
